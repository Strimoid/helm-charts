...
helm.sh/chart: {{ include "iframely.chart" . }}
...
*/}}
{{- define "iframely.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "iframely.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
